...
* [DneustadtCsrfCookieBundle](https://github.com/dneustadt/DneustadtCsrfCookieBundle) - Symfony 5 bundle that provides Cross Site Request Forgery (CSRF or XSRF) protection for client-side applications
